...
// MARK: - "Unread notifications" endpoint (notification-list)
// Flat shape: { "status": 200, "message": "...", "data": [ ... ], "pagination": { ... } }
...
struct NotificationDataWrapper: Codable, Equatable {
    let notifications: [NotificationItem]
    let meta: NotificationMeta
}

struct NotificationMeta: Codable, Equatable {
    let currentPage: Int
    let lastPage: Int
    let perPage: Int
    let total: Int
